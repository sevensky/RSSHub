...
```
chromium报错↓
error: Error in /douyin/live/903931313040: Error: Failed to launch the browser process!
/tmp/chromium: error while loading shared libraries: libnss3.so: cannot open shared object file: No such file or directory

sudo apt update
sudo apt install libnss3
sudo ldconfig -p | grep libnss3.so
```
...
[English docs](https://docs.rsshub.app) | [中文文档](https://docs.rsshub.app/zh/) 
