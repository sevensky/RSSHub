...
module.exports = async (ctx) => {
    const response = await got({
        ...
        headers: {
            Referer: `https://www..com/news/flash`,//https://www.egsea.com/news/flash.html
        },
    });
    ...
    ({
        ...
        link: 'https://www.egsea.com' + item.url,
        pubDate: new Date(item.pageTime * 1000).toUTCString(),
        description: item.content,
    }));
    
    /*{
        const pubDate = new Date(item.pageTime * 1000).toUTCString();
