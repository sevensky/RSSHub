...
// rsshub.xiximiao.com/ppk/fxbaogao/report
router.get('/ppk/fxbaogao/report', lazyloadRouteHandler('./routes_k/fxbaogao/report'));
// 龙瀚资讯 rsshub.xiximiao.com/ppk/yulonghan 
router.get('/ppk/yulonghan', lazyloadRouteHandler('./routes_k/yulonghan/index'));
// 早报 rsshub.xiximiao.com/ppk/yulonghan/history
router.get('/ppk/yulonghan/history', lazyloadRouteHandler('./routes_k/yulonghan/history'));
// rsshub.xiximiao.com/ppk/eastmoney/mingjia/1
router.get('/ppk/eastmoney/mingjia/:id', lazyloadRouteHandler('./routes_k/eastmoney/mingjia'));

// 格隆汇  张忆东 rsshub.xiximiao.com/ppk/gelonghui/user/107600
router.get('/ppk/gelonghui/user/:id', lazyloadRouteHandler('./routes_k/gelonghui/user'));
router.get('/ppk/gelonghui/subject/:id', lazyloadRouteHandler('./routes_k/gelonghui/subject'));
router.get('/ppk/gelonghui/keyword/:keyword', lazyloadRouteHandler('./routes_k/gelonghui/keyword'));
// 新榜
router.get('/ppk/newrank/wechat/:wxid', lazyloadRouteHandler('./routes_k/newrank/wechat'));
router.get('/ppk/newrank/douyin/:dyid', lazyloadRouteHandler('./routes_k/newrank/douyin'));
// e 公司 http://rsshub.xiximiao.com/ppk/egsea-flash
router.get('/ppk/egsea-flash', lazyloadRouteHandler('./routes_k/egsea/flash'));
// 中证网
router.get('/ppk/cs/news/:caty', lazyloadRouteHandler('./routes_k/cs/news'));

// 财联社 rsshub.xiximiao.com/ppk/cls/telegraph
router.get('/ppk/cls/telegraph', lazyloadRouteHandler('./routes_k/cls/telegraph'));
router.get('/ppk/cls/depth', lazyloadRouteHandler('./routes_k/cls/depth'));
router.get('/ppk/cls/depth/:caty', lazyloadRouteHandler('./routes_k/cls/depth'));

// 微博
router.get('/ppk/weibo/user/:uid/:displayVideo?', lazyloadRouteHandler('./routes_k/weibo/user'));
router.get('/ppk/weibo/keyword/:keyword', lazyloadRouteHandler('./routes_k/weibo/keyword'));
router.get('/ppk/weibo/search/hot', lazyloadRouteHandler('./routes_k/weibo/search/hot'));
router.get('/ppk/weibo/super_index/:id', lazyloadRouteHandler('./routes_k/weibo/super_index'));
router.get('/ppk/weibo/oasis/user/:userid', lazyloadRouteHandler('./routes_k/weibo/oasis/user'));

// 选股宝 http://rsshub.xiximiao.com/ppk/xuangubao/subject/35
router.get('/ppk/xuangubao/subject/:subject_id', lazyloadRouteHandler('./routes_k/xuangubao/subject'));
/*
